...
public class MathSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == MathPackage.eINSTANCE)
			...
			case MathPackage.PARENTHESIS:
				...
				return; 
			case MathPackage.PI_USE:
				sequence_FunctionUse(context, (PiUse) semanticObject); 
				return; 
			case MathPackage.PLUS:
				sequence_Exp(context, (Plus) semanticObject); 
				return; 
			case MathPackage.POWER_USE:
				sequence_PowerUse(context, (PowerUse) semanticObject); 
				return; 
			case MathPackage.PROGRAM:
				sequence_Program(context, (Program) semanticObject); 
				return; 
			case MathPackage.SQRT_USE:
				sequence_SqrtUse(context, (SqrtUse) semanticObject); 
				return; 
	 ...
	 *
	 * Constraint:
	 *     (functions+=Function* exp=MathExp)
	 * </pre>
	 */
	 ...
	 * <pre>
	 * Contexts:
	 *     FunctionUse returns PiUse
	 *     Exp returns PiUse
	 *     Exp.Plus_1_0_0_0 returns PiUse
	 *     Exp.Minus_1_0_1_0 returns PiUse
	 *     Factor returns PiUse
	 *     Factor.Mult_1_0_0_0 returns PiUse
	 *     Factor.Div_1_0_1_0 returns PiUse
	 *     Primary returns PiUse
	 *
	 * Constraint:
	 *     value=PI
	 * </pre>
	 */
	protected void sequence_FunctionUse(ISerializationContext context, PiUse semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.PI_USE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.PI_USE__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFunctionUseAccess().getValuePIParserRuleCall_2_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 * <pre>
	 * Contexts:
	 *     FunctionUse returns PowerUse
	 *     PowerUse returns PowerUse
	 *     Exp returns PowerUse
	 *     Exp.Plus_1_0_0_0 returns PowerUse
	 *     Exp.Minus_1_0_1_0 returns PowerUse
	 *     Factor returns PowerUse
	 *     Factor.Mult_1_0_0_0 returns PowerUse
	 *     Factor.Div_1_0_1_0 returns PowerUse
	 *     Primary returns PowerUse
	 *
	 * Constraint:
	 *     (first=Exp second=Exp)
	 * </pre>
	 */
	protected void sequence_PowerUse(ISerializationContext context, PowerUse semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.POWER_USE__FIRST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.POWER_USE__FIRST));
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.POWER_USE__SECOND) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.POWER_USE__SECOND));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getPowerUseAccess().getFirstExpParserRuleCall_2_0(), semanticObject.getFirst());
		feeder.accept(grammarAccess.getPowerUseAccess().getSecondExpParserRuleCall_4_0(), semanticObject.getSecond());
		feeder.finish();
	}
	...
	protected void sequence_Program(ISerializationContext context, Program semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.PROGRAM__EXTERNALS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.PROGRAM__EXTERNALS));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getProgramAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getProgramAccess().getExternalsExternalDefParserRuleCall_2_0(), semanticObject.getExternals());
		feeder.finish();
	}
	 ...
	 * <pre>
	 * Contexts:
	 *     FunctionUse returns SqrtUse
	 *     SqrtUse returns SqrtUse
	 *     Exp returns SqrtUse
	 *     Exp.Plus_1_0_0_0 returns SqrtUse
	 *     Exp.Minus_1_0_1_0 returns SqrtUse
	 *     Factor returns SqrtUse
	 *     Factor.Mult_1_0_0_0 returns SqrtUse
	 *     Factor.Div_1_0_1_0 returns SqrtUse
	 *     Primary returns SqrtUse
	 *
	 * Constraint:
	 *     exp=Exp
	 * </pre>
	 */
	protected void sequence_SqrtUse(ISerializationContext context, SqrtUse semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, MathPackage.Literals.SQRT_USE__EXP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MathPackage.Literals.SQRT_USE__EXP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSqrtUseAccess().getExpExpParserRuleCall_2_0(), semanticObject.getExp());
		feeder.finish();
	}
